...
bool Controller::checkCrashWithSnake(const Segment& newHead)
{
...
bool Controller::checkOutOfMap(const Segment& newHead)
{
...
void Controller::checkReceiveFoodAndPlaceNew(const std::unique_ptr<Event>& e)
{
...
void Controller::checkIfNewFoodCollitedWithSnake(const std::unique_ptr<Event>& e)
{
...
void Controller::receive(std::unique_ptr<Event> e)
{
    try {
        ...
        try {
            ...
            try {
                checkReceiveFoodAndPlaceNew(e);
            } catch (std::bad_cast&) {
                try {
                    checkIfNewFoodCollitedWithSnake(e);
                } catch (std::bad_cast&) {
